...
Page({
  data: {
    ...
    lastcat:[],
    course:[],
    addrMap:'/images/map.png',
    addrMap_r:'/images/x_right.png',
    addrName:'成都市白果林...'
  }, getMapAddr:function(e){
    wx.navigateTo({
...
getMore:function(e){
  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      success: function (res) {  
          var jj = JSON.parse(res.data.result);
        var ggtop = jj.ggtop;
        var procat = jj.procat;
        var prolist = jj.prolist;
        var brand = jj.brand;
        var course = jj.course;
        //that.initProductData(data);
        that.setData({
          imgUrls:ggtop,
          proCat:procat,
